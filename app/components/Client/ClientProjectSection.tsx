          ...
          <div className="text-center">
            <div className="mb-8">
              ...
              <p className="text-gray-400 max-w-xl mx-auto mb-6">
                We&apos;re having trouble loading project data. Please check
        ...
        >
          {projects.map((project) => (
            <motion.div
              ...
              className="bg-gray-800/50 backdrop-blur-sm rounded-xl overflow-hidden border border-gray-700/50 transition-all duration-50 hover:shadow-xl hover:shadow-blue-900/20"
              whileHover={{ y: -6 }}
