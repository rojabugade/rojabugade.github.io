(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_@splinetool_runtime_build_ui_9675ae.js", {
...
var Qr = ((ae)=>("TURBOPACK compile-time value", "function") < "u" ? ("TURBOPACK ident replacement", __turbopack_require_stub__) : typeof Proxy < "u" ? new Proxy(ae, {
        get: (ge, m)=>(("TURBOPACK compile-time value", "function") < "u" ? ("TURBOPACK ident replacement", __turbopack_require_stub__) : ge)[m]
    }) : ae)(function(ae) {
    if (("TURBOPACK compile-time value", "function") < "u") return ("TURBOPACK ident replacement", __turbopack_require_stub__).apply(this, arguments);
...
` + i.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    typeof zr == "object" && typeof Kt == "object" ? Kt.exports = Zr : typeof define == "function" && define.amd && ((r)=>r !== undefined && __turbopack_export_value__(r))((()=>Zr)());
});
const __TURBOPACK__default__export__ = Jn();
}}),
}]);

//# sourceMappingURL=node_modules_%40splinetool_runtime_build_ui_9675ae.js.map